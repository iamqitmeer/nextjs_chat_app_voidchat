...
export default function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-brand-bg p-4">
      ...
      <motion.div
        ...
        className="z-10 flex flex-col items-center gap-4 rounded-3xl border border-brand-subtle bg-brand-surface/80 p-8 shadow-2xl shadow-brand-accent/10 backdrop-blur-2xl"
      >
        <div className="flex items-center gap-3 text-zinc-100">
          <MessageCircle className="h-12 w-12 animate-glow text-brand-accent" />
